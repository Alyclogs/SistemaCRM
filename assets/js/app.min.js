    ...
    if (e.target.closest('.edicion-grupo')) {
        ...
        const inputHTML = {
            texto: () =>
                ...
                name="extra_${campo.nombre}" value="${element.textContent.trim()}">`,

            numero: () =>
                `<input type="number" id="${element.id}" class="form-control" 
                name="extra_${campo.nombre}" value="${Number(element.textContent.trim())}">`,

            booleano: () =>
                `<select class="form-select w-auto" id="${element.id}" name="extra_${campo.nombre}">
            ...
            opciones: () =>
                `<select class="form-select" id="${element.id}" name="extra_${campo.nombre}">
                ${campo.valor_inicial
                    .map(
                        opcion =>
        ...
        row.querySelector(".btn-actualizar").addEventListener("click", () => {
            ...
            const extra = { [campo.nombre]: newContent };
