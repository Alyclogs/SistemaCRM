<div class="h-100 d-flex flex-column p-4">
    <div class="d-flex h-100 gap-3 rounded-4 shadow">
        <div class="bg-light disable-hover"
            style="width: 25%;
            ...
            <div class="h-100 p-4">
                ...
                <div class="info-container bg-light clickable selected" data-target="campos">
                    <div class="d-flex gap-3 align-items-center">
                        <?php include('./assets/svg/edit.svg'); ?>
                        <h6>Campos personalizados</h6>
                    </div>
                </div>
                <div class="info-container bg-light clickable" data-target="roles">
                    <div class="d-flex gap-3 align-items-center">
